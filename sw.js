// sw.js
const VERSION = '2025.08.13-0559';
const CACHE_NAME = 'brainlock-cache-' + VERSION;
const ASSETS = ['./','./index.html?v=2025.08.13-0559','./manifest.webmanifest?v=2025.08.13-0559','./app.js?v=2025.08.13-0559','./model.js?v=2025.08.13-0559','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
