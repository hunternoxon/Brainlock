export default class BrainlockApp {
  ...
  qs(){ const g=id=>document.getElementById(id); return {
    ...
    dbgBtn:g('dbgBtn'), dbgDlg:g('dbgDlg'), closeDbg:g('closeDbg'), dbgOut:g('dbgOut')
  };}
  ...
  pushNextTrick(){ const t=this.model.selectTrick(); this.current=t; this.attempts=1; this.missHistory=[]; this.landHistory=[]; this.ui.trickText.textContent=this.model.trickText(t); this.ui.subText.textContent='Attempt 1 of 3'; this.updateHUD(); this.debugDump(); }
